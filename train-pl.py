...
#model = DonutModelPLModule.load_from_checkpoint("./lightning_logs/version_0/checkpoints/epoch=0-step=559.ckpt")
## ===============
...
# trainer.fit(model, ckpt_path="./lightning_logs/version_0/checkpoints/epoch=0-step=559.ckpt")
#
# trainer = pl.Trainer(
#         # 继续训练
#         resume_from_checkpoint="./lightning_logs/version_0/checkpoints/epoch=0-step=559.ckpt",
#         accelerator="gpu",
#         devices=1,
#         max_epochs=config.get("max_epochs"),
#         val_check_interval=config.get("val_check_interval"),
...
#trainer.test(model_module, test_dataloaders=val_dataloader, ckpt_path="./lightning_logs/version_0/checkpoints/epoch=0-step=559.ckpt")
print("trained")
#
